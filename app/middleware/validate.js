...
module.exports = {
    ...
    parkingGive: validation.parkingGive,
    changeDate: validation.changeDate,
    requestBooking: validation.requestBooking,
    parkingTakeConfirm: validation.parkingTakeConfirm,
    parkingVisitorConfirm: validation.parkingVisitorConfirm,
    parkingCancel: validation.parkingCancel,
